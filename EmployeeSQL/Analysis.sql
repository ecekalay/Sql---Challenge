...
select dept.dept_no,
	   ...
	   emp.last_name,
	   emp.first_name
from dept_manager man, department dept, employees emp 
where man.dept_no = dept.dept_no and man.emp_no = emp.emp_no; 	 
...
select emp.emp_no,
	   ...
	   emp.first_name,
       dept.dept_name
from employees emp, dept_emp demp, department dept 
where emp.emp_no = demp.emp_no and demp.dept_no = dept.dept_no; 
...
select emp.emp_no,
	   ...
	   dept.dept_name
from employees emp, dept_emp demp, department dept
where emp.emp_no = demp.emp_no and demp.dept_no = dept.dept_no and dept.dept_name = 'Sales';
...
select emp.emp_no,
	   ...
	   dept.dept_name
from employees emp, dept_emp demp, department dept
where emp.emp_no = demp.emp_no and demp.dept_no = dept.dept_no and 
